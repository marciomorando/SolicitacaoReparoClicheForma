 ...
 */
public class Visualizar_Cliche extends javax.swing.JFrame {

    /**
     * Creates new form Visualizar_Cliche
     */
    public Visualizar_Cliche() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        sOPASTAStatusClicheQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT s FROM SOPASTAStatusCliche s");
        sOPASTAStatusClicheList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : sOPASTAStatusClicheQuery.getResultList();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTable1 = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("SOPASTA - Clichês");

        jTable1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, sOPASTAStatusClicheList, jTable1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Visualizar_Cliche.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Visualizar_Cliche().setVisible(true);
            }
        });
    }
    ...
    private java.util.List<gui.SOPASTAStatusCliche> sOPASTAStatusClicheList;
    private javax.persistence.Query sOPASTAStatusClicheQuery;
